...
def combine_half_model(ahalf_model_path, bhalf_model_path, config_path, model_output_path):
    ...
    for k in ahalf_model_params_keys:
        ...
        if k.startswith('trelm_roberta.embeddings') or \
            k.startswith('trelm_roberta.encoder.tlayer') or \
            k.startswith('trelm_roberta.pooler') or \
            ...
            if new_params_dict[k].is_floating_point():
                ...
                new_params_dict[k] //= 2
        elif k.startswith('trelm_roberta.encoder.layer'):

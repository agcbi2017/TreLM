...
parser.add_argument("--fixed_tgt_emb", type=bool_flag, default=False, help="Fixed the target embeddings when training")
parser.add_argument("--eval_word_translation", type=bool_flag, default=False, help="Evaluate the word translation when training")
parser.add_argument("--eval_sent_translation", type=bool_flag, default=False, help="Evaluate the sentence translation when training")
